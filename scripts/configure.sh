...
docker tag -f jenkins:1.609.1 tdcd_registry:5000/jenkins:1.609.1
docker push tdcd_registry:5000/jenkins:1.609.1
docker build -t tdcd_jenkins $IMAGES/jenkins
docker tag -f tdcd_jenkins tdcd_registry:5000/tdcd_jenkins
docker push tdcd_registry:5000/tdcd_jenkins
